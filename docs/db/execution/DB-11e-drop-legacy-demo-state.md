...
- **Deployed** 2026-09-23 21:24 UTC, `5254b8f`, contract label `pre-db11e`; 80 migrations; `POST /api/admin/tenants/1/extend` → 404; client 1.0.49 (int-route hooks gone), dashboard bump builds with no source change.
