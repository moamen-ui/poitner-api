...
## State coupling
```
R2-03-03 <- reset           # consumes a restart window (`Pointer__SkillVersion` override)
R2-03-04 <- R2-03-03        # its step 1 is pre-window and its step 2 runs inside R2-03-03's window
```
