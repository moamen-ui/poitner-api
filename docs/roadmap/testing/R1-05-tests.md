...
- R1-05-06's toast is fire-and-forget DOM — `expect.poll` (≤ 10 s), never a fixed sleep; the
  positive control (step 4) is what distinguishes the 403 toast from a generic failure toast.
