...
## State coupling
```
R1-09-01 <- reset           # asserts a freshly seeded catalog
R1-09-02 <- reset           # the only scenario that restarts the API, and it asserts migration idempotency
R1-09-05 <- R1-09-03        # uses the project R1-09-03 creates
R1-09-06 <- R1-09-03        # uses the project R1-09-03 creates
R1-09-07 <- R1-05-06        # needs `PORTS.beta` released by R1-05-06
R1-09-08 <- R1-09-03        # uses the project R1-09-03 creates
R1-09-09 <- R1-09-06        # needs the catalog state R1-09-06 restores in its step 7
R1-09-10 <- R1-09-06        # needs the catalog state R1-09-06 restores in its step 7
```
