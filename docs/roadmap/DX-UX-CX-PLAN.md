...
| # | Item | Est. |
|---|---|---|
| R5.1 | **§55** DB-11 family (identity, memberships, deletion, change-e-mail) — **shipped 2026-09-23** (DB-11a 00:08 UTC, DB-11b, DB-11c ~04:55 UTC, DB-11d ~05:50 UTC; dashboard UI publishing) — [`docs/db/execution/DB-11a-identity-and-workspace-memberships.md`](../db/execution/DB-11a-identity-and-workspace-memberships.md), [`DB-11b-login-workspace-picker-and-switch.md`](../db/execution/DB-11b-login-workspace-picker-and-switch.md), [`DB-11c-deletion-semantics-remove-disable-erase.md`](../db/execution/DB-11c-deletion-semantics-remove-disable-erase.md), [`DB-11d-change-email.md`](../db/execution/DB-11d-change-email.md) | 5–7 d |
| R5.2 | **§16** audit log (un-held) — `docs/db/execution/DB-12-*.md` (not yet written; schema in parallel with DB-11b/c) | 3–4 d |
| R5.3 | **§56** operator access / impersonation (F2) — **shipped 2026-09-23** (~06:15 UTC, `441a462`+`5f1fbc8`+`790b9b8`; 72 migrations; metadata-only by default, read-only timed session; dashboard UI publishing) — [`docs/db/execution/DB-13-operator-impersonation.md`](../db/execution/DB-13-operator-impersonation.md) | 2–3 d |
