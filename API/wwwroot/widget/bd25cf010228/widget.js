...
@media (prefers-reduced-motion: reduce){
  ...
  var STRINGS = {
    en: {
      ...
      "toast.pinElementNotFound": "This comment's element isn't currently visible on the page (it may be hidden, removed, or only shown temporarily)",
    ...
    ar: {
      ...
      "toast.pinElementNotFound": "عنصر هذا التعليق غير ظاهر حاليًا في الصفحة (قد يكون مخفيًا أو محذوفًا أو يظهر مؤقتًا فقط)",
