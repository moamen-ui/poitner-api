...
public class DeviceLoginMapping : IEntityTypeConfiguration<DeviceLogin>
{
    public void Configure(EntityTypeBuilder<DeviceLogin> b)
    {
        ...
        b.Property(x => x.DeviceCodeHash).HasColumnName("device_code_hash").HasMaxLength(64).IsRequired();
        ...
        b.HasIndex(x => x.DeviceCodeHash).IsUnique().HasDatabaseName("ux_device_logins_device_code_hash");
