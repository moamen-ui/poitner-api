...
namespace Pointer.Infrastructure.Migrations
{
    ...
    [Migration("20260926124759_AddBillingV1SubscriptionAndInviteColumns")]
    partial class AddBillingV1SubscriptionAndInviteColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pointer.Domain.Entity.Comment", b =>
                {
                    ...
                    b.Property<DateTime?>("ScreenshotPurgedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("screenshot_purged_at");
            ...
            modelBuilder.Entity("Pointer.Domain.Entity.UserRecoveryCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Pointer.Domain.Entity.Workspace", b =>
                {
                    ...
                    b.Property<DateTime?>("DeletionReminderSentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("deletion_reminder_sent_at");
                    ...
                    b.Property<int?>("DemoCommentCapOverride")
                        .HasColumnType("integer")
                        .HasColumnName("demo_comment_cap_override");

                    b.Property<DateTime?>("DemoConvertedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("demo_converted_at");

                    b.Property<DateTime?>("DemoExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("demo_expires_at");

                    b.Property<DateTime?>("DemoExpiryWarnedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("demo_expiry_warned_at");

                    b.Property<DateTime?>("DemoExtendedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("demo_extended_at");

                    b.Property<int?>("DemoTtlHoursOverride")
                        .HasColumnType("integer")
                        .HasColumnName("demo_ttl_hours_override");
                    ...
                    b.Property<bool>("PausedByOperator")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.ToTable("workspaces", null, t =>
                        {
                            t.HasCheckConstraint("ck_workspaces_deletion_request_consistent", "(deletion_requested_at IS NULL) = (deletion_requested_by IS NULL)");

                            t.HasCheckConstraint("ck_workspaces_deletion_schedule_consistent", "(deletion_confirmed_at IS NULL) = (deletion_scheduled_for IS NULL) AND (deletion_confirmed_at IS NULL OR deletion_requested_at IS NOT NULL) AND (deletion_reminder_sent_at IS NULL OR deletion_scheduled_for IS NOT NULL)");

                            t.HasCheckConstraint("ck_workspaces_name_not_blank", "length(btrim(name)) > 0");

                            t.HasCheckConstraint("ck_workspaces_pause_consistent", "(paused_at IS NULL) = (paused_by IS NULL) AND (paused_at IS NOT NULL OR NOT paused_by_operator)");
                        });
                });
                    ...
                    b.OwnsOne("Pointer.Domain.ValueObjects.PlanEntitlements", "Entitlements", b1 =>
                        {
                            ...
                            b1.Property<int?>("MaxOwnedWorkspaces")
                                .HasColumnType("integer");
                            ...
                            b1.Property<bool?>("NewWorkspaceRequiresApproval")
                                .HasColumnType("boolean");
